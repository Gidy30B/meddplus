...
const Navbar = () => {
  ...
  <div className="bg-yellow-400  flex items-center justify-center" style={{ width: '30%', height: '40px' }}>
  ...
  <div className="bg-blue-500 text-white font-bold text-sm italic flex items-center p-1" style={{ width: '70%', minHeight: '40px' }}>
    <span style={{ fontSize: '12px' }}>Medplus<sup>+</sup></span>
      ...
      <Modal isOpen={isMenuOpen} onClose={toggleMenu} className="fixed inset-y-0 left-0 z-50 bg-white w-45/100 transform transition-transform ease-in-out duration-300">
